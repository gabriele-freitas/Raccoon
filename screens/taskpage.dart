...
import 'package:todo1/database_helper.dart';
import 'package:todo1/models/task.dart';
import 'package:todo1/models/todo.dart';
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onSubmitted: (value) async {
                              //Checa se a entrada não está vazia
                              if(value!= "") {
                                //Checa se a tarefa/task é nula
                                if(widget.task == null){
                            ...
                            style: TextStyle(
                              fontSize: 26.0,
                              fontWeight: FontWeight.bold, //para deixar em negrito a escrita
